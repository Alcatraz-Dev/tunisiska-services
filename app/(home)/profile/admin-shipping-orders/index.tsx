...
export default function AdminShippingOrdersScreen() {
    ...
    <SafeAreaView className={`flex-1 ${isDark ? "bg-dark" : "bg-white"}`}>
      ...
      <View className="flex-1 mt-6">
        <View className="px-6 mb-6">
            <AutoText className={`text-2xl font-bold ${isDark ? "text-white" : "text-gray-900"}`}>Sändningar</AutoText>
            <AutoText className="text-gray-500 text-sm mt-1">Hantera logistik och fraktbeställningar</AutoText>
        </View>
        ...
        <AdminDataList 
          ...
          onItemPress={(item) => {
            console.log("Selected order:", item._id);
          }}
        />
      </View>
    </SafeAreaView>

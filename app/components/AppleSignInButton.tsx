...
export default function AppleSignInButton({ setUserProfile, forceDark }: Props) {
  useWarmUpBrowser();
  ...
  const updateUserMetadata = async (
    ...
    try {
      ...
      await showAlert("Sparad", "Din Apple-profil har uppdaterats!");
    } catch (error) {
      console.error("❌ Error updating Clerk metadata:", error);
      showAlert("Error", "Kunde inte uppdatera Apple-profilen");
    }
  };
